...
static NSString* const kSignImage         = @"signImage";
...
- (NSData *) signImage {
    return [[DataDefault defaults] objectForKey:kSignImage];
}

-(void) setSignImage:(NSData *)signImage{
    [[DataDefault defaults] setObject:signImage forKey:kSignImage];
    [[DataDefault defaults] synchronize];
}
